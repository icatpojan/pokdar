    ...
    <header class="fixed-top custom-header">
        ...
        <div class="top-header">
            <div class="container d-flex justify-content-between align-items-center py-2">
                ...
                <button class="navbar-toggler d-lg-none border-0 text-white" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
        ...
        <!-- Main Navbar (Dark) -->
        <nav class="navbar navbar-expand-lg main-navbar-ugm p-3">
